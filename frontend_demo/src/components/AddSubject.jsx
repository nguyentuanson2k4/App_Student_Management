...
// const AddSubject = ({ handleSubjectAdded }) => {
...
//                 ...form,
//                 credits: Number(form.credit) // Đảm bảo tín chỉ là số
//             });
...
//         } catch (error) {
//             console.error(error);
//             toast.error(error.response?.data?.message || "Lỗi khi thêm môn học");
//         }
//     };
...
//         //         <Button variant="gradient" size="xl" onClick={addSubject}>
...
//                     <p className="text-sm text-gray-500">Quản lý và thêm mới các học phần</p>
//                 </div>
//             </div>
...
//                         value={form.description}
//                         onChange={handleChange}
//                         className="sm:col-span-2 bg-white/50"
//                     />
//                 </div>
//             </div>
...
//                 <Button variant="gradient" size="xl" onClick={addSubject} className="flex-1 sm:flex-none">
//                     <Plus className="size-5 mr-2" />
//                     Thêm môn học
//                 </Button>
//                 <Button
...
//                     className="bg-white/50 border-purple-200 hover:bg-purple-50 text-purple-700 flex-1 sm:flex-none"
//                 >
//                     <ArrowLeft className="size-5 mr-2 transition-transform group-hover:-translate-x-1" />
//                     Quay Lại
//                 </Button>
//             </div>
//         </Card>
